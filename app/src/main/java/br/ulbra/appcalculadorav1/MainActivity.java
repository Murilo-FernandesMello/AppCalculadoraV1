...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button numeroZero, numeroUm, numeroDois, numeroTres,
            ...
            soma, subtracao, igual, botao_limpar, raiz, potencia2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        potencia2.setOnClickListener(this);
        ...
        potencia2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            double x = Double.parseDouble(txtExpressao.getText().toString());
            txtResultado.setText(String.valueOf(Math.pow(x,2)));
            }
        });
    ...
    private void iniciarComponentes() {
        ...
        potencia2 = findViewById(R.id.potencia);
